...
const Enchants: Enchant[] = [
  ...
  // Tier 6 (special enchants)
  {
    name: "Omniscient",
    color: ["rgb(255,255,255)", "rgb(0,0,0)"],
    chance: 0.15,
    valueMultiplier: 1100,
    damageMultiplier: 1100,
    luckMultiplier: 1100,
    experienceMultiplier: 1100,
    tier: 6,
  },
  {
    name: "Ascendancy",
